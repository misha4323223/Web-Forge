...
## Часть 2: Создание Cloud Function (для форм)

### Шаг 1: Открой консоль Яндекс Cloud
1. Зайди на [console.cloud.yandex.ru](https://console.cloud.yandex.ru)
2. Войди в свой аккаунт

### Шаг 2: Перейди в Cloud Functions
...
### Шаг 5: Загрузи код
1. В разделе "Способ" выбери **"Редактор кода"**
2. Удали всё содержимое в файле `index.js`
3. Открой на компьютере файл: `yandex-cloud-function/index.js`
4. Скопируй всё содержимое и вставь в редактор
5. Также создай файл `package.json` (кнопка "+" рядом с файлами)
6. Скопируй содержимое из `yandex-cloud-function/package.json`

### Шаг 6: Добавь переменные окружения (опционально)
