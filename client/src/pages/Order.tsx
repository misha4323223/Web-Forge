...
const projectTypes: ProjectTypeConfig[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      "Облачный хостинг (масштабируемый)",
      "SSL сертификат",
      "Резервные копии БД",
...
const features: Feature[] = [
  ...
  { id: "payment", label: "Онлайн-оплата", price: 35000, description: "Платёжные системы", availableFor: ["landing", "corporate", "shop"] },
  ...
  { id: "auth_advanced", label: "Расширенная аутентификация", price: 35000, description: "2FA, OAuth, SAML", availableFor: ["webapp"] },
  { id: "websocket", label: "Реал-тайм синхронизация", price: 45000, description: "WebSocket, live обновления данных", availableFor: ["webapp"] },
  { id: "redis_cache", label: "Кэширование", price: 30000, description: "Высокопроизводительный кэш для быстрого доступа", availableFor: ["webapp"] },
  { id: "monitoring", label: "Мониторинг и логирование", price: 40000, description: "Отслеживание ошибок и производительности", availableFor: ["webapp"] },
  { id: "api_docs", label: "API документация и SDK", price: 25000, description: "Полная документация и клиентские SDK", availableFor: ["webapp"] },
  { id: "cicd_pipeline", label: "CI/CD и автоматизация", price: 35000, description: "Автотесты, автоматическое тестирование и деплой", availableFor: ["webapp"] },
  { id: "mobile_api", label: "Мобильное приложение API", price: 50000, description: "iOS/Android интеграция", availableFor: ["webapp"] },
  { id: "load_balancing", label: "Балансировка нагрузки", price: 60000, description: "Масштабирование для высоких нагрузок", availableFor: ["webapp"] },
  ...
  { id: "payment_gateway", label: "Платёжные системы", price: 40000, description: "Интеграция различных платёжных методов", availableFor: ["webapp"] },
  { id: "notification_system", label: "Система уведомлений", price: 35000, description: "Email, SMS, Push, Telegram", availableFor: ["webapp"] },
  { id: "file_storage", label: "Облачное хранилище файлов", price: 30000, description: "Масштабируемое хранилище данных", availableFor: ["webapp"] },
...
const orderSchema = z.object({
  ...
  projectType: z.enum(["bizcard", "landing", "corporate", "shop", "webapp"]),
