...
export default function RealEstateAgency() {
  ...
  useDocumentMeta({
    title: "ЛюксПро — Агенство недвижимости премиум-класса | Покупка и продажа",
    description: "Агенство недвижимости с опытными агентами. Апартаменты, дома, коммерческая недвижимость. Персональный сервис, честные цены, онлайн-просмотры.",
    keywords: "недвижимость, апартаменты, купить дом, агенство, агент по недвижимости",
    ogTitle: "ЛюксПро — Агенство недвижимости | Дизайн от MP.WebStudio",
