...
const faqs = [
  {
    ...
    answer: "Лендинг — одностраничный сайт для продвижения конкретного товара/услуги с фокусом на конверсию. Корпоративный сайт — многостраничный портал компании с информацией об услугах, командой, контактами. Интернет-магазин — платформа с каталогом товаров, корзиной, платежной системой и управлением заказами."
  },
  {
    question: "Сколько времени занимает разработка сайта?",
    answer: "В среднем: Лендинг — 2-3 недели, Корпоративный сайт — 3-4 недели, Интернет-магазин — 4-6 недель. Сроки зависят от сложности, количества функций и скорости согласования макетов. Мы соблюдаем график и держим вас в курсе каждый этап."
  },
  {
  ...
  },
  {
    ...
    answer: "В стандартную поддержку входит: исправление ошибок в течение 3 месяцев, техническая консультация, помощь с обновлением контента. Дополнительные услуги (SEO, дизайн обновлений, расширение функционала) оплачиваются отдельно через систему дополнительных счетов."
  },
  {
    question: "Вы помогаете с покупкой домена и хостингом?",
    answer: "Да! Мы помогаем выбрать домен, переносим DNS, настраиваем SSL-сертификат. Хостинг можно разместить у нас (Яндекс Cloud) или вы можете использовать свой. Все настройки включены в процесс запуска проекта."
  },
  {
  ...
  },
  {
    ...
    answer: "К любому проекту можно добавить: интеграцию с 1С, CRM, email-маркетинг, видео на фоне, чат-бот, личный кабинет пользователя, рекомендательную систему, аналитику, многоязычность и многое другое. Полный список доступен в калькуляторе."
  },
  {
