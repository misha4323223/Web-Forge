...
const services = [
  {
    ...
    description: "Создаём представительские сайты, которые формируют доверие к вашему бренду и привлекают клиентов.",
  ...
  },
  {
    icon: Palette,
    title: "UI/UX Дизайн",
    description: "Проектируем пользовательские интерфейсы, которые интуитивно понятны и визуально привлекательны.",
    color: "from-orange-500 to-red-500",
  },
  {
    icon: Gauge,
    title: "Оптимизация",
    description: "Ускоряем загрузку, улучшаем SEO и повышаем конверсию существующих сайтов.",
    color: "from-yellow-500 to-orange-500",
  },
  {
    icon: Code,
    title: "Техподдержка",
    description: "Обеспечиваем бесперебойную работу, обновления и развитие ваших веб-проектов.",
