...
const projects = [
  ...
  },
  {
    ...
    description: "Система управления заказами с интеграцией amoCRM, уведомлениями в Telegram и аналитикой",
    tags: ["React", "Node.js", "amoCRM", "Яндекс.Метрика"],
  ...
  },
  {
    ...
    description: "Внутренний портал для компании с интеграцией 1С и Битрикс24",
    tags: ["Vue.js", "PostgreSQL", "1С", "Битрикс24"],
