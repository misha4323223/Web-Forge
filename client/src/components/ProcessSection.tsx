...
const steps = [
  ...
  },
  {
    number: "02",
    title: "Дизайн",
    description: "Создаём рабочую версию сайта и отправляем ссылку на превью. Вносим правки до полного согласования.",
    icon: PenTool,
  },
  {
    number: "03",
    title: "Интеграции",
    description: "Подключаем оплату, доставку, аналитику и другие необходимые сервисы. Проводим тестирование.",
    icon: Code,
  },
  {
    number: "04",
    title: "Запуск",
    description: "Разворачиваем проект на сервере клиента, настраиваем домен и передаём готовый продукт.",
    icon: Rocket,
  },
];
